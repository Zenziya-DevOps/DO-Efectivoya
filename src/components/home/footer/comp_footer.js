              ...
              <>
                <Row className="pt-5 pb-5">
                  <Col xs={0} className="my-auto text-center">
                    <img src={`${efectivoya__}`} className="img img-fluid" />
                  </Col>
                ...
                <Row className="mt-4 text-center">
                  ...
                  <Col xs={2}>
                    {" "}
                    <a href={`${land}Privacidad`}>
                      {" "}
                      <u style={label_(0, 0, "12px")}>Privacidad</u>
                    </a>
                  </Col>
                  <Col xs={2}>
                    {" "}
                    <a href={`${land}Consentimiento`}>
                      {" "}
                      <u style={label_(0, 0, "12px")}>
                  ...
                  <Col xs={2}>
                    <a
                      className="p-2"
                      href="https://www.facebook.com/EYDO-107584304945063"
                    >
                      <img
                        src={`${facebook}`}
                        className="img img-fluid"
              ...
              <>
                <Row>
                  <Col xs={12} className="p-5">
                    <img src={`${efectivoya_}`} className="img img-fluid" />
                  </Col>
                  ...
                  <Col xs={12} className="pt-2 pl-5">
                    {" "}
                    <a href={`${land}Consentimiento`}>
                      <u style={label_(0, 0, "12px")}>Términos y condiciones</u>
                    </a>
                  </Col>
                  <Col xs={12} className="pt-2 pl-5">
                    {" "}
