...
import aprobado from "../../images/aprobado.svg"
import aprocheck from "../../images/aprocheck.svg"
...
export class COMP_Aprob extends Component {
  ...
  componentWillMount() {
    ...
    window.gtag("event", "conversion", {
      send_to: "AW-377670293/oTOmCIayjeQCEJWVi7QB",
    })
  ...
  onRenderer({ seconds, api }) {
    ...
    return (
      <label style={label_(1, 0, "0.8em", 0, "normal", "0.9rem")}>
        En {seconds} segundos avanza al chat
      </label>
    )
  }
    ...
    return (
      <div id="process" className="p-3 my-auto">
        ...
        <Col xs={12} className="pt-3 font-weight-bold">
          <label className="col-12" style={label_(0, 0, "16px")}>
            Has sido aprobado por:
          </label>
          <label className="col-12" style={label_(2, 0, "24px")}>
            RD$ {this.props.Data.MontoOfrecido}{" "}
          </label>
          ...
          <Row className="d-flex justify-content-center">
            <div className="text-left col-10">
              ...
              >
                ...
                <span style={label_(0, 0)}>cuotas de </span>RD${" "}
                {Calcular(
                  this.props.Data.FrecuenciaOfrecida == 1
                    ? 30
                ...
                <span style={label_(0, 0)}>cada una.</span>
              </label>
            </div>
              ...
              >
                ...
                <span style={label_(0, 0)}>
                  {this.props.Data.FrecuenciaOfrecida
                    ...
                    : new Date(
                        new Date().setDate(
                          new Date().getDate() + product.Frecuencia
                        )
                      )
                        .toJSON()
                        .slice(0, 10)
          ...
          <a
            href={`https://api.whatsapp.com/send/?phone=18494104542&text=Mi+numero+de+c%C3%A9dula+es+${client.DocumentNumber}+y+%C2%A1Quiero+un+pr%C3%A9stamo+Efectivo+Ya!&app_absent=0`}
          >
            <Button
              id="paso3a"
              onClick={
