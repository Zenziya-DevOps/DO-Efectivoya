            ...
            <Row>
              ...
              <Col xs={12} className="pt-2">
                <p
                  ...
                  style={label_(0, 0, "16px")}
                >
                  No podemos prestarte dinero <p>en este momento</p>
                </p>
                <p
                  className="pt-2 font-weight-normal"
                  style={label_(0, 0, "12px")}
                >
                  Con gusto volveremos a analizar <p>tu caso en unos días</p>
                </p>
                <div className="pt-2 pb-3">
                  <Button
                    className="pt-2 font-weight-bold"
                    style={Btn_(2, 2, 3, "275px")}
                    type="submit"
                  >
                    ¿Por qué no?
                  </Button>
  ...
  render() {
    return (
      <div id="process" className="pt-3 pb-3">
        <Col xs={12}>
          <label className="font-weight-bold" style={label_(2, 0, "18px")}>
            Algunas recomendaciones para obtener un préstamo con Efectivo Ya:
          </label>
        </Col>
        ...
        <Col xs={12} className="pt-3">
          <div style={{ marginLeft: "-12px" }}>
            <ul style={label_(0, 0, "12px", "left")}>
              <li>
                <strong>Verificar ingresos mensuales:</strong> Es importante
                poder comprobar tu actividad y continuidad laboral.
              </li>
              <li>
                <strong>Pagar tus cuentas a tiempo:</strong> Procura cumplir con
                las fechas y términos acordados.
              </li>
              <li>
                <strong>Saldar tarjetas de crédito:</strong> Esfuérzate en
                mantener los saldos de tus tarjetas de crédito por debajo de 35%
                de tus límites.
              </li>
            </ul>
          </div>
  ...
  render() {
    return (
      <div id="process" className="p-3 my-auto">
        <Col xs={12}>
          <label className="font-weight-bold" style={label_(2, 0, "18px")}>
            !Estamos analizando tu <br /> solicitud!
          </label>
        </Col>
        <Col xs={12}>
          <img
        ...
        <Col xs={12} className="pt-5">
          <label className="font-weight-bold" style={label_(0, 0, "16px")}>
            Aguarda unos instantes para poder continuar con el proceso
          </label>
        </Col>
      </div>
    )
...
class COMP_Estudio extends Component {
  ...
  async componentDidMount() {
    ...
    credit.IdCookie = localStorage.getItem("cookie")
    credit.IpConnection = ip
    credit.Campana = 1 // 1 = efectivo ya, 2 = efectivo simple
    ...
    if (this.state.result.Done != null) {
      ...
      (this.state.result.Done == null) &
      (this.state.result.Rejected == null) &
      (this.state.result.PreAbrobado == null)
    ) {
        ...
        <Container className="text-center">
          <Row className="my-auto ">
            {this.state.element === 0 ? (
              ...
              <COMP_Deny
                Data={
                  this.state.result.Rejected || this.state.result.PreAbrobado
                }
              />
            )}
          </Row>
